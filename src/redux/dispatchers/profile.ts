...
// Get GitHub repos
export const getGithubRepos: any = (github_username: string) =>
    async (dispatch: AppDispatch) => {
        try {
            const res = await axios.get(
                `/api/profiles/github/${github_username}/`
            )
...
export const createProfile: any = (formData: any, navigate: any, edit = false) =>
    async (dispatch: AppDispatch) => {
        try {
            const config = {
...
// Add Experience
export const addExperience: any = (formData: any, navigate: any) =>
    async (dispatch: AppDispatch) => {
        try {
            const config = {
                headers: { 'Content-Type': 'application/json' },
...
// Add Education
export const addEducation: any = (formData: any, navigate: any) =>
    async (dispatch: AppDispatch) => {
        try {
            const config = {
                headers: { 'Content-Type': 'application/json' },
